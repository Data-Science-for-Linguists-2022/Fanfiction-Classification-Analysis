...
# NOTE: This python script will not function to crawl the web without an open
# scrapy project (and being in the correct folder of that project). I am including
# it here to indicate my process in this progress report.
